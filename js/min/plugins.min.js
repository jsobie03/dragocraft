    ...
    e.flexslider = function (t, a) {
        ...
        e.data(t, "flexslider", n), g = {
            init: function () {
                ...
                }), n.vars.pauseInvisible && g.pauseInvisible.isHidden() || (n.vars.initDelay > 0 ? n.startTimeout = setTimeout(n.play, n.vars.initDelay) : n.play())), m && g.asNav.setup(), o && n.vars.touch && g.touch(), (!p || p && n.vars.smoothHeight) && e(window).bind("resize orientationchange focus", g.resize), n.find("img").attr("draggable", "false"), setTimeout(function () {
                    n.vars.start(n)
                }, 200)
            },
            asNav: {
            ...
            directionNav: {
                setup: function () {
                    ...
                    n.controlsContainer ? (e(n.controlsContainer).append(t), n.directionNav = e("." + s + "direction-nav li a", n.controlsContainer)) : (n.append(t), n.directionNav = e("." + s + "direction-nav li a", n)), g.directionNav.update(), n.directionNav.bind(l, function (t) {
                        t.preventDefault();
                        var a;
                        ("" === c || c === t.type) && (a = e(this).hasClass(s + "next") ? n.getTarget("next") : n.getTarget("prev"), n.flexAnimate(a, n.vars.pauseOnAction)), "" === c && (c = t.type), g.setToClearWatchedEvent()
                    })
                },
                update: function () {
                    var e = s + "disabled";
            ...
            pausePlay: {
                setup: function () {
                    ...
                    n.controlsContainer ? (n.controlsContainer.append(t), n.pausePlay = e("." + s + "pauseplay a", n.controlsContainer)) : (n.append(t), n.pausePlay = e("." + s + "pauseplay a", n)), g.pausePlay.update(n.vars.slideshow ? s + "pause" : s + "play"), n.pausePlay.bind(l, function (t) {
                        t.preventDefault(), ("" === c || c === t.type) && (e(this).hasClass(s + "pause") ? (n.manualPause = !0, n.manualPlay = !1, n.pause()) : (n.manualPause = !1, n.manualPlay = !0, n.play())), "" === c && (c = t.type), g.setToClearWatchedEvent()
                    })
                },
                update: function (e) {
            ...
            touch: function () {
                function e(e) {
                    n.animating ? e.preventDefault() : (window.navigator.msPointerEnabled || 1 === e.touches.length) && (n.pause(), f = d ? n.h : n.w, x = Number(new Date), S = e.touches[0].pageX, w = e.touches[0].pageY, g = v && u && n.animatingTo === n.last ? 0 : v && u ? n.limit - (n.itemW + n.vars.itemMargin) * n.move * n.animatingTo : v && n.currentSlide === n.last ? n.limit : v ? (n.itemW + n.vars.itemMargin) * n.move * n.currentSlide : u ? (n.last - n.currentSlide + n.cloneOffset) * f : (n.currentSlide + n.cloneOffset) * f, c = d ? w : S, m = d ? S : w, t.addEventListener("touchmove", a, !1), t.addEventListener("touchend", i, !1))
                }

                function a(e) {
                    S = e.touches[0].pageX, w = e.touches[0].pageY, h = d ? c - w : c - S, b = d ? Math.abs(h) < Math.abs(S - m) : Math.abs(h) < Math.abs(w - m);
                    var t = 500;
                    (!b || Number(new Date) - x > t) && (e.preventDefault(), !p && n.transitions && (n.vars.animationLoop || (h /= 0 === n.currentSlide && 0 > h || n.currentSlide === n.last && h > 0 ? Math.abs(h) / f + 2 : 1), n.setProps(g + h, "setTouch")))
                }

                function i() {
                    if (t.removeEventListener("touchmove", a, !1), n.animatingTo === n.currentSlide && !b && null !== h) {
                        var e = u ? -h : h,
                            s = e > 0 ? n.getTarget("next") : n.getTarget("prev");
                        n.canAdvance(s) && (Number(new Date) - x < 550 && Math.abs(e) > 50 || Math.abs(e) > f / 2) ? n.flexAnimate(s, n.vars.pauseOnAction) : p || n.flexAnimate(n.currentSlide, n.vars.pauseOnAction, !0)
                    }
                    t.removeEventListener("touchend", i, !1), c = null, m = null, h = null, g = null
                }

                function s(e) {
                    e.stopPropagation(), n.animating ? e.preventDefault() : (n.pause(), t._gesture.addPointer(e.pointerId), y = 0, f = d ? n.h : n.w, x = Number(new Date), g = v && u && n.animatingTo === n.last ? 0 : v && u ? n.limit - (n.itemW + n.vars.itemMargin) * n.move * n.animatingTo : v && n.currentSlide === n.last ? n.limit : v ? (n.itemW + n.vars.itemMargin) * n.move * n.currentSlide : u ? (n.last - n.currentSlide + n.cloneOffset) * f : (n.currentSlide + n.cloneOffset) * f)
                }
                ...
                function o(e) {
                    ...
                    if (a) {
                        var n = -e.translationX,
                            i = -e.translationY;
                        return y += d ? i : n, h = y, b = d ? Math.abs(y) < Math.abs(-n) : Math.abs(y) < Math.abs(-i), e.detail === e.MSGESTURE_FLAG_INERTIA ? (setImmediate(function () {
                            t._gesture.stop()
                        }), void 0) : ((!b || Number(new Date) - x > 500) && (e.preventDefault(), !p && a.transitions && (a.vars.animationLoop || (h = y / (0 === a.currentSlide && 0 > y || a.currentSlide === a.last && y > 0 ? Math.abs(y) / f + 2 : 1)), a.setProps(g + h, "setTouch"))), void 0)
                    }
                }
                ...
                function l(e) {
                    ...
                    if (t) {
                        if (t.animatingTo === t.currentSlide && !b && null !== h) {
                            ...
                            t.canAdvance(n) && (Number(new Date) - x < 550 && Math.abs(a) > 50 || Math.abs(a) > f / 2) ? t.flexAnimate(n, t.vars.pauseOnAction) : p || t.flexAnimate(t.currentSlide, t.vars.pauseOnAction, !0)
                        }
                        c = null, m = null, h = null, g = null, y = 0
                    }
                }
                var c, m, g, f, h, x, b = !1,
                    S = 0,
            ...
            resize: function () {
                !n.animating && n.is(":visible") && (v || n.doMath(), p ? g.smoothHeight() : v ? (n.slides.width(n.computedW), n.update(n.pagingCount), n.setProps()) : d ? (n.viewport.height(n.h), n.setProps(n.h, "setTotal")) : (n.vars.smoothHeight && g.smoothHeight(), n.newSlides.width(n.computedW), n.setProps(n.computedW, "setTotal")))
            },
            ...
            if (n.vars.animationLoop || t === n.currentSlide || (n.direction = t > n.currentSlide ? "next" : "prev"), m && 1 === n.pagingCount && (n.direction = n.currentItem < t ? "next" : "prev"), !n.animating && (n.canAdvance(t, l) || i) && n.is(":visible")) {
                ...
                if (n.animating = !0, n.animatingTo = t, a && n.pause(), n.vars.before(n), n.syncExists && !l && g.sync("animate"), n.vars.controlNav && g.controlNav.active(), v || n.slides.removeClass(s + "active-slide").eq(t).addClass(s + "active-slide"), n.atEnd = 0 === t || t === n.last, n.vars.directionNav && g.directionNav.update(), t === n.last && (n.vars.end(n), n.vars.animationLoop || n.pause()), p) o ? (n.slides.eq(n.currentSlide).css({
                    opacity: 0,
                    zIndex: 1
                }), n.slides.eq(t).css({
                    opacity: 1,
                    ...
                    var f, h, x, b = d ? n.slides.filter(":first").height() : n.computedW;
                    v ? (f = n.vars.itemMargin, x = (n.itemW + f) * n.move * n.animatingTo, h = x > n.limit && 1 !== n.visible ? n.limit : x) : h = 0 === n.currentSlide && t === n.count - 1 && n.vars.animationLoop && "next" !== n.direction ? u ? (n.count + n.cloneOffset) * b : 0 : n.currentSlide === n.last && 0 === t && n.vars.animationLoop && "prev" !== n.direction ? u ? 0 : (n.count + 1) * b : u ? (n.count - 1 - t + n.cloneOffset) * b : (t + n.cloneOffset) * b, n.setProps(h, "", n.vars.animationSpeed), n.transitions ? (n.vars.animationLoop && n.atEnd || (n.animating = !1, n.currentSlide = n.animatingTo), n.container.unbind("webkitTransitionEnd transitionend"), n.container.bind("webkitTransitionEnd transitionend", function () {
                        n.wrapup(b)
            ...
            !n.animating && f && n.flexAnimate(n.getTarget("next"))
        }, n.pause = function () {
            ...
            n.doMath(), v || (e < n.currentSlide ? n.currentSlide += 1 : e <= n.currentSlide && 0 !== e && (n.currentSlide -= 1), n.animatingTo = n.currentSlide), n.vars.controlNav && !n.manualControls && ("add" === t && !v || n.pagingCount > n.controlNav.length ? g.controlNav.update("add") : ("remove" === t && !v || n.pagingCount < n.controlNav.length) && (v && n.currentSlide > n.last && (n.currentSlide -= 1, n.animatingTo -= 1), g.controlNav.update("remove", n.last))), n.vars.directionNav && g.directionNav.update()
    ...
    e.fn.lightbox = function (t) {
        var a = {
            ...
            n = {
                ...
                caption: null,
                init: function (t) {
                    n.items = t, n.selector = "lightbox-" + Math.random().toString().replace(".", ""), n.lightbox || (e("body").append('<div id="lightbox" style="display:none;"><a href="#" class="lightbox-close lightbox-button"></a><div class="lightbox-nav"><a href="#" class="lightbox-previous lightbox-button"></a><a href="#" class="lightbox-next lightbox-button"></a></div><div href="#" class="lightbox-caption"><p></p></div></div>'), n.lightbox = e("#lightbox"), n.caption = e(".lightbox-caption", n.lightbox)), n.items.length > 1 && a.nav ? e(".lightbox-nav", n.lightbox).show() : e(".lightbox-nav", n.lightbox).hide(), n.bindEvents()
                },
                loadImage: function () {
                    a.blur && e("body").addClass("blurred"), e("img", n.lightbox).remove(), n.lightbox.fadeIn("fast").append('<span class="lightbox-loading"></span>');
                ...
                resizeImage: function () {
                    var t, i, s, r, o;
                    i = e(window).height() - a.margin, s = e(window).outerWidth(!0) - a.margin, n.image.width("").height(""), r = n.image.height(), o = n.image.width(), o > s && (t = s / o, o = s, r = Math.round(r * t)), r > i && (t = i / r, r = i, o = Math.round(o * t)), n.image.width(o).height(r).css({
                ...
                next: function () {
                    return n.locked ? !1 : (n.locked = !0, n.getCurrentIndex() >= n.items.length - 1 ? e(n.items[0]).click() : e(n.items[n.getCurrentIndex() + 1]).click(), void 0)
                },
                previous: function () {
                    return n.locked ? !1 : (n.locked = !0, n.getCurrentIndex() <= 0 ? e(n.items[n.items.length - 1]).click() : e(n.items[n.getCurrentIndex() - 1]).click(), void 0)
                },
                bindEvents: function () {
                    e(n.items).click(function (t) {
                        if (!e("#lightbox").is(":visible") && (e(window).width() < a.minSize || e(window).height() < a.minSize)) return e(this).attr("target", "_blank"), void 0;
                        var i = e(this)[0];
                        t.preventDefault(), n.current = i, n.loadImage(), e(document).on("keydown", function (e) {
